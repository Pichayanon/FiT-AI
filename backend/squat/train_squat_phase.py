...
class PhaseDataset(Dataset):
    def __init__(self, data_dir: str, window=30, stride=5):
        self.samples = []
...
class SimpleTCN(nn.Module):
    def __init__(self, in_dim=10, num_classes=2):
        super().__init__()
...
def train(args):
    ...
    model = SimpleTCN(in_dim=10, num_classes=2).to(device)
