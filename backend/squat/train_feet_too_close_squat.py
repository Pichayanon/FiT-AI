"""
  python squat/train_feet_too_close_squat.py --data dataset/squat/dataset_standing --out squat/models/feet_too_close_tcn.pt
"""
...
def main() -> None:
    ...
    ap.add_argument("--data", required=True, help="folder with *.npz (dataset/dataset_standing)")
    ap.add_argument("--out", required=True, help="output .pt path e.g. squat/models/feet_too_close_tcn.pt")
