"""
  python train_knees_in_squat.py --data dataset_bottom --out models/squat_knees_in_tcn.pt
  python train_knees_in_squat.py --data dataset_bottom --out models/squat_knees_in_tcn.pt --feature_set RAW
...
def main() -> None:
    ...
    ap.add_argument("--data", required=True, help="folder with *.npz (dataset_bottom)")
    ap.add_argument("--out", required=True, help="output .pt path e.g. models/squat_knees_in_tcn.pt")
